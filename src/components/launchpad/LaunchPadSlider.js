...
import LaunchPadvebank from "../../assets/images/launchpad/vebank.jpg";
import LaunchPadraise from "../../assets/images/launchpad/raise-icon.jpg";
...
const LaunchPadSlider = () => {
    ...
    const n = 4;
    return (
        <div className="flex relative mx-auto raise-box ">
            <div className="raise-box-1 relative rounded-xl bg-[url('../../assets/images/launchpad/market3.jpg')] bg-no-repeat bg-center bg-cover">
                <div className="flex w-full p-6 absolute bottom-0">
                    <div className="w-1/2 flex">
                        <img className="mr-4" src={LaunchPadvebank} />
                        <div className="relative w-full">
                            <div className="absolute bottom-0">
                                <p className="text-[24px] font-bold">VeBank</p>
                                <p className="text-[16px] font-normal">One-stop DeFi Platform</p>
                            ...
                            <div className="grid-cols-4 gap-4 flex flex-row justify-center">
                                {
                                    [...Array(n)].map((e, i) =>
                                            <div className="count-down" key={i}>
                                                <p className="text-[24px] leading-[12px]">4</p>
            ...
            <div className="raise-box-2 ml-8 p-8 raise-bg rounded-xl">
                ...
                <div>
                    ...
                    <div className="slider-parent">
                        <input class="input-suplly rounded-xl" type="range" min="1" max="10000000" value={5000000} disabled />
                    </div>
                </div>
                <div className="pb-8">
